...
INSERT INTO `account` VALUES (1,'abc123','1234567','abc@gmail.com',0,NULL,NULL);
...
DROP TABLE IF EXISTS `account_playlist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `account_playlist` (
  `account_account_id` bigint NOT NULL,
  `playlist_id` bigint NOT NULL,
  UNIQUE KEY `UK_qgtnut065pagde67la0ff3oq2` (`playlist_id`),
  KEY `FK5btb7s2ijtmdw46ojwmd7uhft` (`account_account_id`),
  CONSTRAINT `FK5btb7s2ijtmdw46ojwmd7uhft` FOREIGN KEY (`account_account_id`) REFERENCES `account` (`account_id`),
  CONSTRAINT `FKn1d3lnnq6gooqqhr90ahr6alm` FOREIGN KEY (`playlist_id`) REFERENCES `playlist` (`id`)
...
LOCK TABLES `account_playlist` WRITE;
/*!40000 ALTER TABLE `account_playlist` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_playlist` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `end_user` VALUES (1,'Ben',23,0,0,NULL,NULL);
...
CREATE TABLE `end_user_accounts` (
  ...
  `end_user_user_id` bigint NOT NULL,
  `accounts_account_id` bigint NOT NULL,
  UNIQUE KEY `UK_17j5l4pkwjogh46bxb2m3fvfh` (`accounts_id`),
  UNIQUE KEY `UK_cjp77256uqjprwtyhq7pbh6ge` (`accounts_account_id`),
  KEY `FKq7ycdxs7ytnosv262h7knbsmy` (`end_user_user_id`),
  CONSTRAINT `FKkepmkll61cs3otdxpwchp0k99` FOREIGN KEY (`accounts_account_id`) REFERENCES `account` (`account_id`),
  CONSTRAINT `FKq7ycdxs7ytnosv262h7knbsmy` FOREIGN KEY (`end_user_user_id`) REFERENCES `end_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `playlist` VALUES (1,'playlist#1',0,'');
...
CREATE TABLE `playlist_songs` (
  ...
  CONSTRAINT `FKf5rt0kg266cdttc1xucp6dpg8` FOREIGN KEY (`playlist_id`) REFERENCES `playlist` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-05-15 16:20:52
